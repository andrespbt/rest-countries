...
export const CardList = ({ data = [] }) => {
  ...
  return (
    <>
      <ul className="w-[80%] flex flex-col items-center mx-auto px-6 md:flex-row gap-4 flex-wrap md:px-0 md:mx-0 md:w-full  md:my-8 md:gap-0 md:gap-x-24 md:justify-center">
